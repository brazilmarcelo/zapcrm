// OpenAPI 3.1.2 "source of truth" for the CRM white-label Public API.
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'CRM White-Label Public API',
      version: 'v1',
      description:
        'API pública do CRM white-label para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
